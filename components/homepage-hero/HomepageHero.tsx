...
export const HomepageHero = () => {
    ...
    return (
        <section className="min-h-screen py-container-block-sm sm:py-container-block flex-col-center"
                 id="homepageHero">
            <div className="container">
                <Heading variant="hero" align="center"
                         className="col-span-full row-start-2 row-span-1 md:col-span-6 md:row-start-2">
                        ...
                        {data?.cta && (
                            <Link href={data.cta.link} variant="primary">
                                ...
                                <CompassIcon size={20} weight="fill"
                                             className="group-hover:rotate-180 transition-transform duration-300 ease-animation-in-out"/>
                            </Link>
                        )}
                        {data?.secondaryCta && (
                ...
                />
                <div
                    className="rounded-full w-full h-full aspect-square col-start-1 col-span-2 row-start-3 row-span-1 md:col-start-5 md:row-start-1 self-end flex-center">
