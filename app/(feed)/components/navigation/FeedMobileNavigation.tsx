...
export const FeedMobileNavigation = () => {
    return (
        <div className="bg-surface flex-col-center pb-safe-bottom fixed inset-x-0 bottom-0 z-50 h-fit">
            <div className="container">
                <div className="col-span-full flex-row-between justify-center items-center gap-x-2">
                    <MobileMenu/>
